...
<div style="height: 1250px;width: 1470px;border: solid black 15px;border-radius: 20px;background-color: rgb(198, 139, 30);display: flex;">
...
<div style="height: 1250px;width: 250px;border: solid black 10px; position: absolute;background-color: rgb(201, 201, 201); top: 130px;left: 1520px;">
    ...
    <button class="user-bouton" onclick="window.location.href = 'user-biblio.php'">
        Bibliothèque
    </button>
    <button class="user-bouton" onclick="window.location.href = 'user-profil.php'">
        Profil
    </button>
</div>
</body>
